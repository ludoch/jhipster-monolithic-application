package serverless.monolithic.repository;

import serverless.monolithic.JhipsterMonnolithicApplicationApp;
import serverless.monolithic.config.Constants;
import serverless.monolithic.config.audit.AuditEventConverter;
import serverless.monolithic.domain.PersistentAuditEvent;
...
import static serverless.monolithic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
